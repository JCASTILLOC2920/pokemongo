...
document.addEventListener('DOMContentLoaded', () => {
    const pokedex = [
      ...
      "Zacian#888#Galar","Zamazenta#889#Galar","Eternatus#890#Galar","Kubfu#891#Galar","Urshifu#892#Galar",
      "Tatsugiri#977#Paldea"
    ];

    const searchInput = document.getElementById('globalSearchInput');
    const suggestionsBox = document.getElementById('globalSuggestions');
    ...
    function showSuggestions(value) {
        ...
        matches.forEach(match => {
            ...
            div.onclick = () => {
                const page = regionPageMap[match.region];
                if (page) {
